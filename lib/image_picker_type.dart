  ...
  Future<CroppedFile?> getCroppedImage(ImagePickerType type) async {
    ...
    return ImageCropper().cropImage(
      ...
      aspectRatio: CropAspectRatio(
        ratioX: size.height.toDouble(),
        ratioY: size.width.toDouble(),
      ),
      uiSettings: [
        AndroidUiSettings(
          ...
          activeControlsWidgetColor: androidSettings?.activeControlsWidgetColor,
        ...
        IOSUiSettings(
          ...
          resetAspectRatioEnabled: iosSettings?.resetAspectRatioEnabled ?? true,
          aspectRatioLockDimensionSwapEnabled:
          iosSettings?.aspectRatioLockDimensionSwapEnabled ?? false,
          aspectRatioLockEnabled: iosSettings?.aspectRatioLockEnabled ?? false,
